...
namespace BH.Engine.Adapters.OpenStreetMap
{
    public static partial class Convert
    {
        ...
        private static Feature ToFeature(CustomObject customObject)
        {
            ...
            {
                Reflection.Compute.RecordError("The customObject provided could not be converted to a Geospatial point feature.");
                return null;
            }
        ...
        private static Feature ToFeature(CustomObject customObject, Dictionary<long, Feature> nodes)
        {
            ...
            {
                Reflection.Compute.RecordError("The customObject provided could not be converted to a Geospatial LineString or Polyline feature.");
                return null;
            }
        ...
        private static Feature ToFeature(CustomObject customObject, Dictionary<long, Feature> ways, Dictionary<long, Feature> nodes)
        {
            ...
            {
                Reflection.Compute.RecordError("The customObject provided could not be converted to a Geospatial MultiPolygon or FeatureCollection feature.");
                return null;
            }
