...
namespace BH.Adapter.OpenStreetMap
{
    public static partial class Convert
    {
        ...
        private static Feature ToFeature(CustomObject customObject)
        {
            ...
            {
                BH.Engine.Reflection.Compute.RecordError("The customObject provided could not be converted to a Geospatial point feature.");
                return null;
            }
        ...
        private static Feature ToFeature(CustomObject customObject, Dictionary<long, Feature> nodes)
        {
            ...
            {
                BH.Engine.Reflection.Compute.RecordError("The customObject provided could not be converted to a Geospatial LineString or Polyline feature.");
                return null;
            }
        ...
        private static Feature ToFeature(CustomObject customObject, Dictionary<long, Feature> ways, Dictionary<long, Feature> nodes)
        {
            ...
            {
                BH.Engine.Reflection.Compute.RecordError("The customObject provided could not be converted to a Geospatial MultiPolygon or FeatureCollection feature.");
                return null;
            }
